  ...
  return (
    <section id="pricing" className="bg-[#C5DFFD] py-10 md:py-16 lg:py-20">
      <div className="container-custom">
        {/* Outer container border wrapping everything */}
        <div className="border-2 border-white/40 rounded-[32px] md:rounded-[48px] lg:rounded-[64px] p-6 sm:p-8 md:p-12 lg:p-16 xl:p-20 bg-white/5 backdrop-blur-sm">
          <div className="flex flex-col items-center gap-8 md:gap-12 lg:gap-16">
            ...
            <div className="w-full max-w-[600px]">
              <div className="relative">
                <div className="border border-[#0089F0] rounded-[20px] md:rounded-[40px] p-5 md:p-8 lg:p-10 w-full bg-white/50 relative shadow-[0_8px_32px_rgba(1,118,206,0.15)] md:shadow-[0_12px_48px_rgba(1,118,206,0.2)]">
                  <div className="space-y-4 md:space-y-6 lg:space-y-8 text-left">
                    ...
                    <p className="font-dm-sans text-[10px] sm:text-xs md:text-sm lg:text-[14px] text-[#0089F0] pt-2 md:pt-3">
                      *After 18 months, transition your data to cold storage for
                      $1/TB on archival data you access infrequently.
                    </p>
                  </div>
